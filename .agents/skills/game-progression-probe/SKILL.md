...
2. Discover the current capabilities through `initialize`, `tools/list`, `resources/list`, `prompts/list`, and read-only state/UI tools. Do not rely on selectors or waits from older runs.
